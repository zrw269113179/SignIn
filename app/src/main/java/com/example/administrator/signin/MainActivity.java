...
public class MainActivity extends AppCompatActivity {
    ...
    private android.widget.Button notarrive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.notarrive = (Button) findViewById(R.id.not_arrive);
                            ...
                            query.findObjects(MainActivity.this, new FindListener<GeoPoint>() {
                                ...
                                public void onSuccess(List<GeoPoint> list) {
                                    if (list.size() != 1){
                                        ...
                                        Latitude2 = list.get(0).getLatitude();
                                            ...
                                            query.findObjects(MainActivity.this, new FindListener<Record>() {
                                                ...
                                                public void onSuccess(List<Record> list) {
                                                    if (list.isEmpty()){
                                                        ...
                                                        Toast.makeText(MainActivity.this, "已签到！", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
        ...
        notarrive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String temp = title.getText().toString();
                if (temp.isEmpty()) {
                    Toast.makeText(MainActivity.this, "请输入缺勤原因", Toast.LENGTH_SHORT).show();
                } else {
                    NotArrive not = new NotArrive();
                    not.setName(user.getName());
                    not.setId(Integer.valueOf(user.getUsername()));
                    not.setTitle(temp);
